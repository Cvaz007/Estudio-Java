package org.sebas.ejemploestructuradatos.list.sebas.estructuradatos.encuentratuvuelo;
...
public class Main {
    public static void main(String[] args) throws ParseException {
        ...
        //para organizar hacemos un sort
        ...
        llegadas.sort((v1, v2) -> Integer.valueOf(v2.getCantPasajeros()).compareTo(v1.getCantPasajeros()));
        Vuelo vueloNenorNumero = new LinkedList<>(llegadas).peekLast();
        System.out.println("El vuelo con menor número de pasajeros es " + vueloNenorNumero.getNombre() + ": " + vueloNenorNumero.getOrigen()+ ", con " + vueloNenorNumero.getCantPasajeros() + " pasajeros.");
    }
}
